...
const CardSorteo = (props) => {
  ...
  return (
    <div className="bg-gradient-to-br from-neutral-600 to-neutral-500 dark:from-neutral-900 dark:to-neutral-800 hover:scale-105 shadow-lg transition-transform duration-300 text-white rounded-lg p-6 flex flex-col gap-4">
