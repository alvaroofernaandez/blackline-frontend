...
const DiseñosModal = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            <div className="relative max-w-3xl w-full h-[75%] mx-4 bg-gradient-to-tl border border-neutral-800 from-neutral-800 via-neutral-900 to-neutral-950 p-6 rounded-lg">
                <button
                ...
                <span className='flex flex-col gap-3 mt-2'>
                    ...
                    <div className='flex columns-3 gap-4 items-center justify-center h-[33rem] md:h-[45rem] lg:h-[35rem] flex-wrap mt-10 overflow-y-scroll'>
                        <CardDiseñoModal />
                        <CardDiseñoModal />
                        <CardDiseñoModal />
                        <CardDiseñoModal />
