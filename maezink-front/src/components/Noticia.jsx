...
const Noticia = () => {
    return (
        <div className="border-2 border-white p-8 rounded-xl bg-black bg-opacity-20 w-full transition duration-500 ease-in-out hover:scale-105 hover:bg-opacity-40 hover:border-gray-400">
